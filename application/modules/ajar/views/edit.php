                ...
                <div class="col-7">
                    <div class="card">
                        <div class="card-body table-responsive">
                            ...
                            <?= form_open() ?>
                            <input type="hidden" name="id_ajar" class="form-control" placeholder="2020-2021" value="<?= $get_ajar['id_ajar'] ?>">
                            <div class="form-group">
                                <label for="">Tahun Ajar <span class="text-danger">*</span></label>
                                <input type="text" name="tahun_ajar" class="form-control" placeholder="2020-2021" value="<?= $get_ajar['tahun_ajar'] ?>">
                            ...
                            <div class="form-group">
                                ...
                                <select name="id_pelajaran" id="" class="form-control">
                                    ...
                                    <?php foreach ($get_pelajaran as $pelajaran) : ?>
                                        <option value="<?= $pelajaran['id_pelajaran'] ?>" <?php if ($get_ajar['id_pelajaran'] == $pelajaran['id_pelajaran']) : ?> selected <?php endif; ?>><?= $pelajaran['deskripsi'] ?></option>
                                    <?php endforeach; ?>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-input">
                                    <div class="input-group-prepend">
                                        <input type="text" class="form-control" id="id_guru" name="id_guru" placeholder="Pilih id guru" readonly value="<?= $get_ajar['id_guru'] ?>">
