                    ...
                    <div class="card">
                        <div class="card-body table-responsive">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="id_pelajaran" id="" class="form-control">
                                            ...
                                            <?php foreach ($get_pelajaran as $pelajaran) : ?>
                                                <option value="<?= $pelajaran['id'] ?>"><?= $pelajaran['deskripsi'] ?></option>
                                            <?php endforeach; ?>
                                        </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-input">
                                    <div class="input-group-prepend">
                                        ...
                                        <input type="text" class="form-control" id="nis" name="nis" placeholder="Pilih id siswa" readonly>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="nilai" class="form-control" placeholder="input nilai">
