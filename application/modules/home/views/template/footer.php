    ...
    <div class="container py-5">
        <div class="row g-5">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <a class="btn btn-link" href="<?= base_url('home/profile') ?>">Profile</a>
                <a class="btn btn-link" href="<?= base_url('home/galeri') ?>">Galeri</a>
                <a class="btn btn-link" href="<?= base_url('home/pendaftaran') ?>">Pendaftaran</a>
            </div>
        </div>
    </div>
    <div class="container">
        <div class="copyright">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    &copy; <a href="#">SMA Negeri 7 Luwu Timur</a>, All Right Reserved.
                </div>
