                ...
                <div class="col-7">
                    <div class="card">
                        <div class="card-body table-responsive">
                            ...
                            <?= form_open() ?>
                            <input type="hidden" name="id_tempati" value="<?= $get_tempati['id_tempati'] ?>">
                            <div class="form-group">
                                <label for="">Tahun Ajar <span class="text-danger">*</span></label>
                                <input type="text" name="tahun_ajar" class="form-control" placeholder="2020-2021" value="<?= $get_tempati['tahun_ajar'] ?>">
