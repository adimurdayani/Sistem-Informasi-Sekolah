                    ...
                    <div class="card">
                        <div class="card-body table-responsive">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="tahun" class="form-control" placeholder="Input nis nasional" value="<?= $get_alumni['tahun'] ?>" required>
                                <small class="text-danger"><?= form_error('tahun') ?></small>
                            </div>

                            <div class="form-group">
                                <label for="">Jumlah <span class="text-danger">*</span></label>
                                <input type="number" name="jumlah" class="form-control" placeholder="Input jumlah" value="<?= $get_alumni['jumlah'] ?>" required>
