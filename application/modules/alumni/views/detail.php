...
<div class="content-page">
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <a href="<?= base_url('siswa') ?>" class="btn btn-secondary"><i class="fe-arrow-left"></i> Kembali</a>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="nis_nasional" class="form-control" placeholder="Input nis nasional" value="<?= $get_siswa['nis_nasional'] ?>" readonly>
                                        <small class="text-danger"><?= form_error('nis_nasional') ?></small>
                                    </div>

                                    <div class="form-group">
                                        <label for="">Nama <span class="text-danger">*</span></label>
                                        <input type="text" name="nama" class="form-control" placeholder="Input nama" value="<?= $get_siswa['nama'] ?>" readonly>
                                        <small class="text-danger"><?= form_error('nama') ?></small>
                                    </div>

                                    <div class="form-group">
                                        <label for="">Jenis Kelamin <span class="text-danger">*</span></label>
                                        <select name="jenis_kelamin" id="" class="form-control" readonly>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="tempat_lahir" class="form-control" placeholder="Input tempat lahir" value="<?= $get_siswa['tempat_lahir'] ?>" readonly>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="tanggal_lahir" class="form-control" placeholder="Input tanggal lahir" value="<?= $get_siswa['tanggal_lahir'] ?>" readonly>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="agama" id="" class="form-control" readonly>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="alamat" class="form-control" rows="5" readonly><?= $get_siswa['alamat'] ?></textarea>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="anak_ke" class="form-control" value="<?= $get_siswa['anak_ke'] ?>" placeholder="Input anak ke" readonly>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="tahun_masuk" class="form-control" value="<?= $get_siswa['tahun_masuk'] ?>" placeholder="Input tahun masuk" readonly>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="tahun_keluar" class="form-control" value="<?= $get_siswa['tahun_keluar'] ?>" placeholder="Input tahun keluar" readonly>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="email_ortu" class="form-control" value="<?= $get_siswa['email_ortu'] ?>" placeholder="Input email" readonly>
                                        <small class="text-danger"><?= form_error('email') ?></small>
                                    </div>

                                    <div class="form-group">
                                        <label for="">Alasan keluar <span class="text-danger">*</span></label>
                                        <textarea name="alasan_keluar" class="form-control" rows="5" readonly><?= $get_siswa['alasan_keluar'] ?></textarea>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama_bapak" class="form-control" placeholder="Input nama" value="<?= $get_siswa['nama_bapak'] ?>" readonly>
                                        <small class="text-danger"><?= form_error('nama_bapak') ?></small>
                                    </div>

                                    <div class="form-group">
                                        <label for="">Pekerjaan Bapak <span class="text-danger">*</span></label>
                                        <input type="text" name="pekerjaan_bapak" class="form-control" placeholder="Input pekerjaan" value="<?= $get_siswa['pekerjaan_bapak'] ?>" readonly>
                                        <small class="text-danger"><?= form_error('pekerjaan_bapak') ?></small>
                                    </div>

                                    <div class="form-group">
                                        <label for="">Pendidikan Bapak <span class="text-danger">*</span></label>
                                        <select name="pendidikan_bapak" id="" class="form-control" readonly>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="alamat_bapak" class="form-control" rows="5" readonly><?= $get_siswa['alamat_bapak'] ?></textarea>
                                        <small class="text-danger"><?= form_error('alamat_bapak') ?></small>
                                    </div>

                                    <div class="form-group">
                                        <label for="">Telepon Bapak <span class="text-danger">*</span></label>
                                        <input type="number" name="telp_bapak" class="form-control" value="<?= $get_siswa['telp_bapak'] ?>" readonly placeholder="Input nomor telepon">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama_ibu" class="form-control" value="<?= $get_siswa['nama_ibu'] ?>" placeholder="Input nama" readonly>
                                        <small class="text-danger"><?= form_error('nama_ibu') ?></small>
                                    </div>

                                    <div class="form-group">
                                        <label for="">Pekerjaan ibu <span class="text-danger">*</span></label>
                                        <input type="text" name="pekerjaan_ibu" class="form-control" value="<?= $get_siswa['pekerjaan_ibu'] ?>" placeholder="Input pekerjaan" readonly>
                                        <small class="text-danger"><?= form_error('pekerjaan_ibu') ?></small>
                                    </div>

                                    <div class="form-group">
                                        <label for="">Pendidikan ibu <span class="text-danger">*</span></label>
                                        <select name="pendidikan_ibu" id="" class="form-control" readonly>
                                            <option value="">-- Pilih pendidikan --</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="alamat_ibu" class="form-control" rows="5" readonly><?= $get_siswa['alamat_ibu'] ?></textarea>
                                        <small class="text-danger"><?= form_error('alamat_ibu') ?></small>
                                    </div>

                                    <div class="form-group">
                                        <label for="">Telepon ibu <span class="text-danger">*</span></label>
                                        <input type="number" name="telp_ibu" class="form-control" value="<?= $get_siswa['telp_ibu'] ?>" readonly placeholder="Input nomor telepon">
                    ...
                    <div class="card">
                        <div class="card-body table-responsive">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_wali" class="form-control" value="<?= $get_siswa['nama_wali'] ?>" placeholder="Input nama" readonly>
                                <small class="text-danger"><?= form_error('nama_wali') ?></small>
                            </div>

                            <div class="form-group">
                                <label for="">Alamat wali <span class="text-danger">*</span></label>
                                <textarea name="alamat_wali" class="form-control" rows="5" readonly><?= $get_siswa['alamat_wali'] ?></textarea>
                                <small class="text-danger"><?= form_error('alamat_wali') ?></small>
                            </div>

                            <div class="form-group">
                                <label for="">Telepon wali <span class="text-danger">*</span></label>
                                <input type="number" name="telp_wali" class="form-control" value="<?= $get_siswa['telp_wali'] ?>" placeholder="Input nomor telepon" readonly>
                                <small class="text-danger"><?= form_error('telp_wali') ?></small>
                            </div>

                            <div class="form-group">
                                <label for="">Hubungan wali <span class="text-danger">*</span></label>
                                <input type="text" name="hubungan_wali" class="form-control" value="<?= $get_siswa['hubungan_wali'] ?>" placeholder="Input hubungan wali" readonly>
