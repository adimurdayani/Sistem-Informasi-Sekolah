                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="tahun_keluar" class="form-control" placeholder="Input tahun keluar" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="alasan_keluar" class="form-control" rows="5" required></textarea>
